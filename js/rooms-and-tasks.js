...
"Boundary Scan: Touch all four outside corners of the house.",
...
"Initialization Routine: Do 10 pushups, 10 sit-ups, and 10 jumping jacks."
],
"Bathrooms": [
"Emergency Water Reset: Touch the sink for 20 seconds.",
"Sit in a bathtub for 20 seconds."
],
"Closets": [
...
"Boundary Scan: Touch all four outside corners of the church.",
"Clear the Way: Go from the building doors to the parking lot 3 times.",
"Touch Grass: Remove your footwear and stand on the grass for 5 seconds.",
"Vehicle Diagnostics: Place your hand on a car tire for 20 seconds."
],
"Cultural Hall": [
...
"Cold Storage Audit: Open the fridge and name three items out loud.",
"Utensil Sort: Use utensils to spell the word 'ALLY' and then return them.",
"Water Pressure Test: Touch the sink for 20 seconds.",
"Nutrient Calibration: Touch 3 different types of food and name them out loud."
],
"Foyer": [
"Couch Compression Test: Sit on every seat cushion once.",
